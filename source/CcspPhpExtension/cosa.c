...
#define  COSA_PHP_EXT_LOG_FILE_NAME "/fss/gw/var/tmp/logs/cosa_php_ext.log"
#define  COSA_PHP_EXT_DEBUG_FILE    "/fss/gw/var/cosa_php_debug"
#define  COSA_PHP_EXT_PCSIM         "/fss/gw/var/cosa_php_pcsim"
