		...
		*/
		...
		if ($ids[$id] === "4") {
			...
			echo '<div class="form-row odd ">'.
					'<label for="channel_selection">Associate Ethernet Port 4 to TWC Home Network:</label>'.
					'<span class="checkbox"><input type="checkbox" id="port4" name="port4" /></span></br></br></br></br>'.
					'Note: Associating Ethernet Port 4 to TWC Home Network will remove the port from your home network.</br></br>'.
				'</div>'.
